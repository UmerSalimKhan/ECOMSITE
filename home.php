    ...
    <div class="container">
        ...
        <div class="main-container">
            <div class="main">
                <header>
                    <div class="overlay">
                        <h2 class="title"> Ezone.com</h2>
                        <p class="description"> Don't Worry, We Ha
                        </p>
        ...
        <div class="links">
            <ul>
                ...
                <li>
                    <a href="contact us.html" style="--i: 0.15s">Contact us </a>
                </li>
                <li>
                    <a href="signup.html" style="--i: 0.2s">sign in</a>
                </li>
                <li>
